...
const Brands = () => {
  return (
    <section className="relative text-gray-400 bg-gray-700 body-font">
     
      {/* <div className="z-10 leading-none absolute bottom-0 left-0 w-full overflow-hidden rotate-180">
   
      <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" fill='#111827' preserveAspectRatio="none">
